              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <h1 className='text-white text-2xl'>shopee</h1>
                    </div>
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      <span className="inline-flex items-center rounded-xl bg-red-50 px-1  text-xs absolute top-0  font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
                      {cartItems.length}
      </span>
                      </div></Link>
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      {cartItems.length}
                        ...
                        <Link className='bg-white text-black rounded-md p-2' to="/login">
                          Login
                        </Link>
                      {/* Profile dropdown */}
